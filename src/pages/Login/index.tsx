  ...
  return (
    <Page>
      <Card>
        ...
        <Subtitle>Accede a tu cuenta para guardar tus pizarras</Subtitle>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <SubmitBtn type="submit" disabled={loading}>{loading ? 'Ingresando...' : 'Iniciar Sesión'}</SubmitBtn>
        </form>
        <Footer>¿No tienes cuenta? <a href="/signup">Regístrate aquí</a></Footer>
      </Card>
    </Page>
  );
};
